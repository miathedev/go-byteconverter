...
func Read_be_float32(bytes []byte) float32 {
...
func Read_be_float64(bytes []byte) float64 {
...
func Read_be_int8(data []byte) (ret int8) {
...
func Read_be_int16(data []byte) (ret int16) {
	buf := bytes.NewBuffer(data)
	binary.Read(buf, binary.BigEndian, &ret)
	return
}
...
func Read_be_int32(data []byte) (ret int32) {
	buf := bytes.NewBuffer(data)
	binary.Read(buf, binary.BigEndian, &ret)
	return
}
...
func Read_be_int64(data []byte) (ret int64) {
	buf := bytes.NewBuffer(data)
	binary.Read(buf, binary.BigEndian, &ret)
	return
}
...
func Read_be_uint8(data []byte) uint8 {
